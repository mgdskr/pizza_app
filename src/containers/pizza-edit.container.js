...
import {pizzaUpdateRemotely} from '../actions/api.js';
import images from '../img/index';
import './pizza-edit.container.css';
                ...
                <div className="pizza-edit__details">
                    ...
                    <Link to="/dashboard">
                        <button className="pizza-edit__save"
                                onClick={this.handlerOnSaveChanges(pizzaId)}>Save changes
                        </button>
                    </Link>
                    <Link to="/dashboard">
